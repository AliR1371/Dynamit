...
[![Sessions](https://img.shields.io/badge/Sessions-14+-blue?style=for-the-badge)](sessions/)
[![Duration](https://img.shields.io/badge/Duration-5%20Hours-green?style=for-the-badge)](#course-structure)
...
This repository is the companion resource for the **Dynamo Inside Revit** YouTube series — a structured, project-focused course that takes you from opening Dynamo for the first time to building powerful automation workflows.
...
**🎓 Course Overview:** 14 complete sessions covering fundamentals to advanced Dynamo concepts with additional content coming soon.

---

## 📚 Course Sessions

### ✅ Published Sessions (14)
...
- **Dynamo Fundamentals** - Software interface and core concepts
- **Element Selection & Filtering** - Working with Revit model elements  
- **Parameter Management** - Reading and modifying element properties
- **Data Structures** - Lists and classes in Dynamo
- **Code Block Programming** - Visual and textual programming in Dynamo
- **Function Writing** - Creating custom functions for complex automation
- **Data Export** - Exporting information to Excel for analysis
- **Advanced Automation** - Leveraging code blocks and parameters
- **View and Level Planning** - Strategic view organization in Revit projects
- **A/B Testing & Hierarchies** - Understanding view relationships and testing workflows
...
### 🔵 Intermediate Level (Sessions 6-11)

Understand class structures in Dynamo, master element parameter editing, work with list operations, and get started with code blocks. Learn data export and advanced parameter techniques.
...
### 🔴 Advanced Level (Sessions 12-14)

Explore powerful parameter manipulation techniques, strategic view planning, and understanding Revit's view hierarchy for sophisticated automation workflows.

| # | Session | Duration | Topics |
|---|---------|----------|--------|
| 12 | Advanced Code Block & Parameters | 28:03 | Advanced techniques, optimization |
| 13 | View Level Design Plan with Complete View Planning | 11:49 | Strategic view organization, view templates |
| 14 | View and Level Hierarchy in Revit – A/B Testing | 12:15 | Hierarchical relationships, testing workflows |

**Key Skills:**
- Advanced parameter automation
- Complex workflow design
- Strategic view planning in Revit
- Understanding view and level hierarchies
- A/B testing and comparison workflows
...
- Basic knowledge of Autodesk Revit
- Familiarity with BIM (Building Information Modeling) concepts
- No prior programming experience required
- Revit 2020 or later with bundled Dynamo
...
### Session 13: View Level Design Plan with Complete View Planning (11:49)
Explore strategic view organization and comprehensive view planning in Revit projects. Learn how to structure views effectively for large-scale projects.

**Topics:**
- View planning strategies
- View templates and organization
- Level-based view creation
- View naming conventions
- Coordinating views across disciplines

**Video:** [Watch on YouTube](https://youtu.be/ObqTeAwW_4w)

---

### Session 14: View and Level Hierarchy in Revit – A/B Testing (12:15)
Understand the hierarchical relationships between views and levels in Revit. Learn A/B testing workflows to compare different design approaches and validate automation processes.

**Topics:**
- View hierarchy fundamentals
- Level relationships
...
✅ Navigate and effectively use the Dynamo interface  
✅ Select and filter elements in Revit models programmatically  
✅ Read and write element parameters using automation  
✅ Work with lists and understand Dynamo data structures  
✅ Write custom functions using code blocks  
✅ Automate repetitive BIM tasks and save hours of manual work  
✅ Export project data to Excel for analysis  
✅ Create advanced automation workflows for complex scenarios  
✅ Plan and organize views strategically in Revit projects  
✅ Understand view and level hierarchies for effective project coordination  
✅ Implement A/B testing workflows for design validation  

---

## 🔗 Resources

- **YouTube Playlist:** [Dynamo Inside Revit Course](https://www.youtube.com/playlist?list=PL2QZXWX4UnsWkFgVwa3Ehot7iusuqyR8B)
- **Repository:** [AliR1371/Dynamit](https://github.com/AliR1371/Dynamit)
- **Autodesk Dynamo:** [Official Website](https://dynamobim.org/)
- **Dynamo Primer:** [Official Learning Guide](https://primer.dynamobim.org/)
- **Dynamo Forum:** [Community Support](https://forum.dynamobim.org/)

---

## 💻 Getting Started

1. **Install Revit & Dynamo** - Dynamo is bundled with Revit 2020 and later
2. **Open a Revit Model** - Use a sample model or your own project
3. **Launch Dynamo** - Go to Manage tab → Dynamo
4. **Watch Session 1** - Start with the introduction
5. **Follow Along** - Pause videos and recreate examples in your own Dynamo session
...
| **Week 5** | Sessions 13-14 | View Planning & Hierarchies |
...
- **YouTube Comments:** Post questions on individual session videos
- **Community Forums:** Visit [forum.dynamobim.org](https://forum.dynamobim.org/)
- **Revit Support:** Check [Autodesk Support](https://www.autodesk.com/support/revit)
...
- **Course Status:** 14 Sessions Published ✅
